...
const translations = {
  en: {
    ...
    achievementsDesc: "Stage 1 and 2 of the Informative, Currently studying a Higher Technician in Software Development.",
    resumeTitle: "Resume",
  ...
  es: {
    ...
    achievementsDesc: "Etapa 1 y 2 del Informatorio, Actualmente cursando Tecnicatura Superior en Desarrollo de Software.",
